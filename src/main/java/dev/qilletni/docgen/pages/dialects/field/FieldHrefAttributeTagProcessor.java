...
/**
 * Creates a link to a field page.
 */
public class FieldHrefAttributeTagProcessor extends AbstractAttributeTagProcessor {
    
    private static final String ATTR_NAME = "link";
    private static final int PRECEDENCE = 10000;

    protected FieldHrefAttributeTagProcessor(String dialectPrefix) {
        super(
    ...
    protected void doProcess(ITemplateContext context, IProcessableElementTag tag,
        ...
        structureHandler.setAttribute("href", "#%s".formatted(AnchorFactory.createAnchorForField(documentedField)));
    }
