...
import dev.qilletni.docgen.pages.dialects.utility.LinkFactory;
 ...
 */
public class FunctionParamTypeAttributeTagProcessor extends AbstractAttributeTagProcessor {

    private static final String ATTR_NAME = "paramtype";
    private static final int PRECEDENCE = 10000;

    protected FunctionParamTypeAttributeTagProcessor(String dialectPrefix) {
        super(
    ...
    protected void doProcess(ITemplateContext context, IProcessableElementTag tag,
        ...
        if (!(executed instanceof DocFieldType docFieldType)) {
            throw new RuntimeException("Expected a DocumentedTypeFunction, got " + executed.getClass().getCanonicalName());
        }

        LinkFactory.populateTypeLink(structureHandler, docFieldType);
    }
}
